...
```{r boot CI of threshold F-test,echo=FALSE, warning=FALSE,message=FALSE,error=FALSE, fig.height=3, fig.width=5.5}
...
```{r boot CI of threshold Rayleigh-test,echo=FALSE, warning=FALSE,message=FALSE,error=FALSE, fig.height=3, fig.width=5.5}
